...
def find_plot_for_example(filename, work_dir):
    ...
    plot_mappings = {
        ...
        "13_planck_blackbody_validation.py": "planck_validation.png",
        "14_rayleigh_scattering_validation.py": "rayleigh_validation.png",
        "15_mie_scattering_validation.py": "mie_validation.png",
        "16_two_stream_benchmarks.py": "two_stream_benchmarks.png",
        "17_solar_spectrum_analysis.py": "solar_spectrum.png",
        "18_thermal_emission_validation.py": "thermal_emission_validation.png",
        "19_path_radiance_remote_sensing.py": "path_radiance.png",
        ...
        "23_infrared_atmospheric_windows.py": "ir_windows.png",
        "24_volcanic_aerosol_forcing.py": "volcanic_forcing.png",
        ...
        # New examples (save to outputs/ directory)
        "36_hitran_gas_absorption.py": "outputs/36_hitran_gas_absorption.png",
        "37_adaptive_optics_simulation.py": "outputs/37_adaptive_optics_simulation.png",
