...
STEFAN_BOLTZMANN = 5.670374419e-8  # W/m^2/K⁴
...
SOLAR_CONSTANT = 1361.0  # W/m^2 (at TOA, mean value)
...
STANDARD_TEMPERATURE = 288.15  # K (15 degC)

# Spectral constants
# First radiation constant: c1 = 2 * h * c^2
FIRST_RADIATION_CONSTANT = 2.0 * PLANCK_CONSTANT * SPEED_OF_LIGHT**2  # W·m^2
